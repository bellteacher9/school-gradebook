...
def add_year_column():
    try:
        ...
        # 1. Name the fourth column header 'year' (D1)
        sheet.update_cell(1, 4, 'year')
        print("Updated cell D1 to 'year'")
        
        # 2. Create the Named Range 'year' for column D (D:D)
        body = {
            "requests": [
                {
                    "addNamedRange": {
        ...
        print("Created named range 'year' for column D")
