...
def add_attendance_column():
    try:
        ...
        # 1. Name the sixth column header 'attendance' (F1)
        sheet.update_cell(1, 6, 'attendance')
        print("Updated cell F1 to 'attendance'")
        
        # 2. Create the Named Range 'attendance' for column F (F:F)
        body = {
            "requests": [
                {
                    "addNamedRange": {
        ...
        print("Created named range 'attendance' for column F")
