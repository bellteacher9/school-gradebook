...
def add_overall_cefr_columns():
    try:
        ...
        headers = ["Term_01_overall_cefr_number", "Term02_overall_cefr_letter"]
        
        # Columns BB and BC are indices 53 and 54
        sheet.update('BB1:BC1', [headers])
        print(f"Updated headers BB1:BC1 to {', '.join(headers)}")
